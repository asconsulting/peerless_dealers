...
/**
 * Class ModulePeerlessDealersReader
 *
 * Front end module "Peerless Dealers Reader".
 */
 
class ModulePeerlessDealersReader extends \Module
{
    ...
    public function generate()
    {
        if (TL_MODE == 'BE')
        {
            ...
            $objTemplate->wildcard = '### ' . utf8_strtoupper($GLOBALS['TL_LANG']['FMD']['peerless_dealers_reader'][0]) . ' ###';
